...
public class Core extends JamGame {
    ...
    public final static IntArray buttonsJustReleased = new IntArray();
    ...
    public static float DEPTH_ENTITIES = 5000;
    public static float DEPTH_DRAGGING = 1000;
    public static Cursor cursorArrow, cursorGrab, cursorPinch, cursorPoint;
    public static ParticleEffect particleAngry, particleBlood, particleBurst, particleCheck, particleHeart, particleMoney, particlePlus, particleStar, particleTooth, particleZ;
    ...
    public static boolean isButtonJustReleased(int button) {
        return button == ANY_BUTTON ? buttonsJustReleased.size > 0 : buttonsJustReleased.contains(button);
    }
    ...
    public static boolean isAnyButtonJustReleased() {
        return buttonsJustReleased.size > 0;
    }
    ...
    public void create() {
        ...
        cursorArrow = Gdx.graphics.newCursor(new Pixmap(Gdx.files.internal("cursors/cursor-arrow.png")), 3, 3);
        cursorGrab = Gdx.graphics.newCursor(new Pixmap(Gdx.files.internal("cursors/cursor-grab.png")), 33, 37);
        cursorPinch = Gdx.graphics.newCursor(new Pixmap(Gdx.files.internal("cursors/cursor-pinch.png")), 30, 45);
        cursorPoint = Gdx.graphics.newCursor(new Pixmap(Gdx.files.internal("cursors/cursor-point.png")), 22, 6);
        ...
        setScreen(new LoadScreen(() -> {
            ...
            particleAngry = new ParticleEffect();
            particleAngry.load(Gdx.files.internal("particles/angry.p"), textures_textures, "particles/");
            
            particleBlood = new ParticleEffect();
            particleBlood.load(Gdx.files.internal("particles/blood.p"), textures_textures, "particles/");
            
            particleBurst = new ParticleEffect();
            particleBurst.load(Gdx.files.internal("particles/burst.p"), textures_textures, "particles/");
            
            particleCheck = new ParticleEffect();
            particleCheck.load(Gdx.files.internal("particles/check.p"), textures_textures, "particles/");
            
            particleHeart = new ParticleEffect();
            particleHeart.load(Gdx.files.internal("particles/heart.p"), textures_textures, "particles/");
            
            particleMoney = new ParticleEffect();
            particleMoney.load(Gdx.files.internal("particles/money.p"), textures_textures, "particles/");
            
            particlePlus = new ParticleEffect();
            particlePlus.load(Gdx.files.internal("particles/plus.p"), textures_textures, "particles/");
            
            particleStar = new ParticleEffect();
            particleStar.load(Gdx.files.internal("particles/star.p"), textures_textures, "particles/");
            
            particleTooth = new ParticleEffect();
            particleTooth.load(Gdx.files.internal("particles/tooth.p"), textures_textures, "particles/");
            
            particleZ = new ParticleEffect();
            particleZ.load(Gdx.files.internal("particles/z.p"), textures_textures, "particles/");
        }));
